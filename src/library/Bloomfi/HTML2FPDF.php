...
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH','Bloomfi/Fonts/');
require_once(RELATIVE_PATH.'HTML2FPDF/FPDF.php');
require_once(RELATIVE_PATH.'HTML2FPDF/htmltoolkit.php');

class Bloomfi_HTML2FPDF extends Bloomfi_HTML2FPDF_FPDF
{
//internal attributes
var $HREF; //! string
var $pgwidth; //! float
...
function Bloomfi_HTML2FPDF($orientation='P',$unit='mm',$format='A4')
{
//! @desc Constructor
//! @return An object (a class instance)
	//Call parent constructor
	$this->Bloomfi_HTML2FPDF_FPDF($orientation,$unit,$format);
